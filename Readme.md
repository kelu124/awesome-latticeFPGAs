...
* [tinyCLUNX33](https://github.com/tinyvision-ai-inc/tinyclunx33) - a 25.4 mm MIPI-to-USB3 System-on-Module built on a Lattice CrossLinkU-NX FPGA running Zephyr, with an open toolchain. [Product](https://tinyvision.ai/pages/tinyclunx33-som-and-devkits).
* [USB-C Industrial Camera](https://github.com/circuitvalley/USB_C_Industrial_Camera_FPGA_USB3) - an open-hardware USB Type-C industrial camera pairing a Cypress FX3 USB3 controller with a CrossLink-NX LIFCL-40.
...
* [BlackIce MX](https://www.tindie.com/products/Folknology/blackice-mx/) (Serial) - by MyStorm **(outdated)**
...
* [Kuchen](https://github.com/machdyne/kuchen) - Kuchen is an FPGA computer by Lone Dynamics based on the iCE40 HX8K, with schematics, PCB, pinouts and example gateware.
* [MiCE47](https://hackaday.io/project/166109-mice47) - NXP i.MXRT1021DAF5A  + iCE40HX8K.
* [Olimex iCE40HX8K-EVB](https://www.olimex.com/Products/FPGA/iCE40/iCE40HX8K-EVB/open-source-hardware) - Olimex open-source-hardware evaluation board for the iCE40 HX8K, KiCad-designed and IceStorm-compatible.
* [Snowflake-FPGA](https://github.com/Wren6991/Snowflake-FPGA) - a cheap Raspberry Pi HAT with an iCE40 HX8K that the Pi programs and talks to over UART/SPI/SDIO.
...
* [FPGA-384](https://www.siliconfrog.co.uk/cgibin/Pages/FPGA384.pl) by SiliconFrog. [SW code on github](https://github.com/siliconfrog/fpga-384). / same for [esp32](https://github.com/siliconfrog/fpga-esp32). [Shop](https://www.tindie.com/products/siliconfrog/fpga-384/). **(outdated)**
* [logic-lp384](https://github.com/Agilack/pmod/tree/master/logic-lp384). PMOD exposing a LP384 KiCad. **(outdated)**
...
* [DIPSY](https://hackaday.io/project/6592-dipsy) (iCE40UL1K-SWG16) **(outdated)**
...
* [ice-dip](https://github.com/fvdhoef/ice-dip) - an iCE40 UltraPlus 5K board in a DIP-40 form factor with machined pin headers, intended for retro-computer designs.
* [ice40-fpga-pico](https://github.com/novasteptech/ice40-fpga-pico) - a compact Raspberry-Pi-Pico-sized UP5K board with an onboard LPC11U35 programmer/UART and USB-C.
* [icehat](https://github.com/emeb/icehat). - with [custom flashing code](https://github.com/emeb/icehat/tree/master/ice_tool) **(outdated)**
...
* [MTX-BC48-DB](https://github.com/mitexus/MTX-BC48-DB-Development-Board) UP5K + BLE  **(outdated)**
* [nrfICE](https://www.crowdsupply.com/hurley-research/nrfice) UP5K + nRF5340
* [pi_smi_up5k](https://github.com/braingram/pi_smi_up5k/blob/main/lattice_fpga_dev_board/lattice_fpga_dev_board_pcb.pdf). Lattice ice40 up5k Raspberry Pi hat designed for using the secondary memory interface (SMI). **(outdated)**
...
* [pico2-ice](https://github.com/tinyvision-ai-inc/pico2-ice) - pairs a Raspberry Pi RP2350 with a Lattice iCE40 UP5K, with independent flash, low-power PSRAM, buttons and Pmod-arranged headers (the RP2350 successor to Pico ICE).
...
* [Obst](https://github.com/machdyne/obst) - Obst is a low-cost ECP5 (LFE5U-12F) FPGA computer by Lone Dynamics.
...
* [Colorlight 5A-75E](https://github.com/q3k/chubby75/blob/master/5a-75e/README.md) - a cheap 16-port HUB75 LED-panel receiver card (LFE5U-25F) reverse-engineered for use as an ECP5 dev board.
...
* [DigitalDevices CineS2 DVB-T2 ](https://www.digital-devices.eu/shop/en/tv-cards/tv-cards-for-pcie/285/digital-devices-cine-s2-v7a-twin-tuner-tv-card-dvb-s/s2-pci-express) **(outdated)**
